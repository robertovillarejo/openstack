...
##[DEFAULT]
sed -i '/\# bind_ip = 0.0.0.0/c bind_ip = 10.0.0.51' /etc/swift/account-server.conf
##bind_port = 6202
...
##[DEFAULT]
sed -i '/\# bind_ip = 0.0.0.0/c bind_ip = 10.0.0.51' /etc/swift/container-server.conf
##bind_port = 6201
...
##[DEFAULT]
sed -i '/\# bind_ip = 0.0.0.0/c bind_ip = 10.0.0.51' /etc/swift/object-server.conf
##bind_port = 6201
